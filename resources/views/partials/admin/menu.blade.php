            ...
            <div class="navbar-content">
                ...
                <ul class="dash-navbar">
                    ...
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li class="dash-item {{ (Request::route()->getName() == 'clients.index' || Request::segment(1) == 'clients' || Request::route()->getName() == 'clients.edit') ? ' active' : '' }}">
                                <a class="dash-link" href="{{ route('clients.index') }}">{{__('Employee')}}</a>
                            </li>
                            @endcan
                        </ul>
                    </li>
                     ...
                     @can('manage ticket')
                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'ticket')?'active':''}}">
                            <a href="{{ route('ticket.index') }}" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-users"></i></span><span class="dash-mtext">{{__('Ticket Request')}}</span>
                            </a>
                        </li>
                        @endcan
                    ...
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'timemodule')?'active':''}}">
                        <a href="{{ route('timemodule.index') }}" class="dash-link"><span class="dash-micon float-start"><i class="ti ti-users"></i></span><span class="dash-mtext">{{ __('Time Module') }}</span></a>
                    </li>
                    @endcan
    
                        @can('manage event')
                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'event')?'active':''}}">
                            <a href="{{ route('event.index') }}" class="dash-link"><span class="dash-micon float-start"><i class="ti ti-calendar-event"></i></span><span class="dash-mtext">{{ __('Workshop') }}</span></a>
                        </li>
                        @endcan
                        @endif
                ...
                <ul class="dash-navbar">
                    ...
                    @can('manage ticket')
                        ...
                        <a href="{{ route('health.index') }}" class="dash-link">
                                ...
                                <span class="dash-micon"><i class="ti ti-arrow-up-right-circle"></i></span><span class="dash-mtext">{{__('Health Journey')}}</span>
                            </a>
                        </li>
                        @endcan
