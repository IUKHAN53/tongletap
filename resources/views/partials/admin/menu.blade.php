...
<style>
    ...
    .company-sidebar .light-sidebar:not(.transprent-bg) {
         top: 0 !important;
         bottom: 0 !important;
         left: 0 !important;
    ...
    .company-sidebar .main-logo a img {
        max-width: 100px;
        /*height: 100%;*/
        object-fit: contain;
    ...
    .company-sidebar .navbar-content {
        position: relative;
    ...
    .company-sidebar.light-sidebar .dash-navbar > .dash-item > .dash-link {
        border-radius: 12px;
        margin-left: 15px;
        margin-right: 15px;
    ...
    body:not(.minimenu) .company-sidebar .dash-link {
        margin: 7px 0;
    }
    .company-sidebar.light-sidebar .dash-link {
        color: #333333;
        font-size: 14px;
    }
    .company-sidebar .dash-link {
        display: block;
        padding: 13px 20px;
        color: #ced4dc;
        position: relative;
...
@if (isset($setting['cust_theme_bg']) && $setting['cust_theme_bg'] == 'on')
    <nav class="{{strtolower(auth()->user()->type) == 'company' ? 'company-sidebar' : 'dash-sidebar'}} light-sidebar transparent-bg">
        @else
            <nav class="dash-sidebar light-sidebar">
                ...
                <div class="navbar-wrapper">
                    ...
                    @if(strtolower(auth()->user()->type) == 'company')
                        @include('partials.admin.company_menu')
                    @else
                            ...
                            @if(\Auth::user()->type != 'client')
                                ...
                                {{ ( Request::segment(1) == null ||Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'income report'
                                   || Request::segment(1) == 'report' || Request::segment(1) == 'reports-payroll' || Request::segment(1) == 'reports-leave' ||
                                                ...
                                                <ul class="dash-submenu">
                                                    ...
                                                    @if( Gate::check('manage leave') || Gate::check('manage attendance'))
                                                        <li class="dash-item dash-hasmenu  {{ (Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee') ? 'active dash-trigger' :''}}">
                                                            <a class="dash-link"
                                                               href="#">{{__('Leave Management Setup')}}
                                        ...
                                        <li class="dash-item dash-hasmenu">
                                            <a href="#!"
                                               class="dash-link {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients')?' active dash-trigger':''}}"><span
                                                        ...
                                                        class="dash-mtext">{{__('User Management')}}</span><span
                                                        class="dash-arrow"><i
                                                            data-feather="chevron-right"></i></span></a>
                                            <ul class="dash-submenu">
                                                @can('manage user')
                                                ...
                                                @can('manage client')
                                                    <li class="dash-item {{ (Request::route()->getName() == 'clients.index' || Request::segment(1) == 'clients' || Request::route()->getName() == 'clients.edit') ? ' active' : '' }}">
                                                        <a class="dash-link"
                                                           href="{{ route('clients.index') }}">{{__('Employee')}}</a>
                                                    </li>
                                                @endcan
                                            </ul>
                                        </li>
                                    ...
                                    <!--------------------- Start Eap Managaement System----------------------------------->
                                    @if(\Auth::user()->type!='super admin')
                                        @can('manage ticket')
                                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'ticket')?'active':''}}">
                                                <a href="{{ route('ticket.index') }}" class="dash-link">
                                                    <span class="dash-micon"><i class="ti ti-users"></i></span><span
                                                            class="dash-mtext">{{__('Ticket Request')}}</span>
                                                </a>
                                            </li>
                                        @endcan

                                        @can('manage time module')
                                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'timemodule')?'active':''}}">
                                                <a href="{{ route('timemodule.index') }}" class="dash-link"><span
                                                            class="dash-micon float-start"><i
                                                                class="ti ti-users"></i></span><span
                                                            class="dash-mtext">{{ __('Time Module') }}</span></a>
                                            </li>
                                        @endcan
                                        @can('manage event')
                                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'event')?'active':''}}">
                                                <a href="{{ route('event.index') }}" class="dash-link"><span
                                                            ...
                                                            class="dash-mtext">{{ __('Workshop') }}</span></a>
                                            </li>
                                        @endcan
                                    @endif
                                    ...
                                    @if(\Auth::user()->show_pos() == 1)
                                        @if( Gate::check('manage warehouse') || Gate::check('manage purchase') || Gate::check('manage pos') || Gate::check('manage print settings'))
                                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show')?' active dash-trigger':''}}">
                                                <a href="#!" class="dash-link"><span class="dash-micon"><i
                                                                class="ti ti-layers-difference"></i></span><span
                                                            class="dash-mtext">{{__('POS System')}}</span><span
                                                            class="dash-arrow"><i
                                                                data-feather="chevron-right"></i></span></a>
                            ...
                            @if((\Auth::user()->type == 'super admin'))
                                <ul class="dash-navbar">
                                    ...
                                    @can('manage health')
                                        <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'health' || Request::segment(1) == 'glucose' || Request::segment(1) == 'exercise' || Request::segment(1) == 'weight' || Request::segment(1) == 'sleep')? 'active dash-trigger' :''}}">
                                            <!-- <a href="{{ route('health.index') }}" class="dash-link"> -->
                                            <a href="{{ route('health.company_choice') }}" class="dash-link">
                                                <span class="dash-micon"><i
                                                            class="ti ti-arrow-up-right-circle"></i></span><span
                                                        class="dash-mtext">{{__('Health Journey')}}</span>
                                            </a>
