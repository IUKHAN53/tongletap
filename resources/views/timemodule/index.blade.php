...
@section('action-btn')
<div class="float-end">
    <a href="#" data-url="{{ route('timemodule.create') }}" data-ajax-popup="true" data-title="{{__('Create Timemodule')}}" data-bs-toggle="tooltip" title="{{__('Create')}}" class="btn btn-sm btn-primary">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btn bg-info ms-2">
                                        <a href="#" data-url="{{ URL::to('timemodule/' . $timemodule->id . '/edit') }}" data-ajax-popup="true" data-title="{{ __('Edit Time Module') }}" data-size="lg" data-bs-toggle="tooltip" title="" class="mx-3 btn btn-sm align-items-center" data-bs-original-title="{{ __('Edit') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btn bg-info ms-2">
                                        <a href="#" data-url="{{ URL::to('timemodule/' . $clientdata->id . '/edit') }}" data-ajax-popup="true" data-title="{{ __('Edit Time Module') }}" data-size="lg" data-bs-toggle="tooltip" title="" class="mx-3 btn btn-sm align-items-center" data-bs-original-title="{{ __('Edit') }}">
                                            <i class="ti ti-pencil text-white"></i>
                                        </a>
                                    </div>
                                    <div class="action-btn bg-danger ms-2">
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['timemodule.destroy', $clientdata->id], 'id' => 'delete-form-' . $clientdata->id]) !!}
                                        <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete" aria-label="Delete">
                                            <i class="ti ti-trash text-white"></i>
                                        </a>
                                        {!! Form::close() !!}
