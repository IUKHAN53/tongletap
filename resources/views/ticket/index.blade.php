                            ...
                            @foreach ($tickets as $ticket)
                                <tr>
                                    ...
                                    <td class="Action">
                                        @if (\Auth::user()->type == 'super admin')
                                            @if($ticket->status == 'approved')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#"
                                                       data-url="{{ URL::to('ticket/' . $ticket->id . '/send-meeting-link') }}"
                                                       data-ajax-popup="true" data-title="{{ __('Send Meeting Link') }}"
                                                       data-size="lg"
                                                       data-bs-toggle="tooltip" title=""
                                                       class="mx-3 btn btn-sm align-items-center"
                                                       data-bs-original-title="{{ __('Send Meeting Link') }}">
                                            ...
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="#"
                                                   data-url="{{ URL::to('ticket/' . $ticket->id . '/edit-status') }}"
                                                   data-ajax-popup="true" data-title="{{ __('Change Ticket Status') }}"
                                                   data-size="lg" data-bs-toggle="tooltip" title=""
                                                   class="mx-3 btn btn-sm align-items-center"
                                                   data-bs-original-title="{{ __('Change Ticket Status') }}">
                                        ...
                                        <div class="action-btn bg-info ms-2">
                                            <a href="#" data-url="{{ URL::to('ticket/' . $ticket->id . '/edit') }}"
