    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="row">
                ...
                <a href="#" class="btn-addnew-project card" data-ajax-popup="true" data-url="{{ route('users.create') }}" data-title="Create New Company" data-bs-toggle="tooltip" title="" data-bs-original-title="Create">
