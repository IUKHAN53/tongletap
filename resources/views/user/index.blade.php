    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                <p class="text-muted text-sm mb-0"
                                                                   data-bs-toggle="tooltip" title="{{__('Users')}}"><i
                                                            ...
                                                            <div class="col-4">
                                                                <p class="text-muted text-sm mb-0"
                                                                   data-bs-toggle="tooltip" title="{{__('Customers')}}">
                                                                    <i class="ti ti-users card-icon-text-space"></i>{{$user->totalCompanyCustomer($user->id)}}
                                                                </p>
                                                            </div>
                                                            <div class="col-4">
                                                                <p class="text-muted text-sm mb-0"
                                                                   data-bs-toggle="tooltip" title="{{__('Vendors')}}"><i
                ...
                @endforeach
                @if( auth()->user()->type == 'super admin')
                    <div class="col-xl-3 col-lg-4 col-sm-6 mt-0">
                        <a href="#" class="btn-addnew-project card" data-ajax-popup="true"
                           data-url="{{ route('users.create') }}" data-title="Create New Company"
                           data-bs-toggle="tooltip" title="" data-bs-original-title="Create">
                            <div class="bg-primary proj-add-icon my-4">
                                <i class="ti ti-plus"></i>
                            </div>
                            <h6 class="mt-4 mb-2">New Company</h6>
