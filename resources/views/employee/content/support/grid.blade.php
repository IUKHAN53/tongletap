...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('employee.support.index') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
           title="{{__('List View')}}">
                ...
                <div class="card card-fluid">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <a href="#" class="avatar rounded-circle">
                                    <img alt="" class="avatar avatar-sm"
                            ...
                            <div class="col">
                                <a href="#"
                                   class="d-block h6 mb-0 text-white">{{!empty($support->createdBy)?$support->createdBy->name:''}}</a>
                                <small class="d-block text-muted  text-white">{{$support->subject}}</small>
                            </div>
                                ...
                                <span class="h6 mb-0">
                                    @if(!empty($support->attachment))
                                        <a href="{{asset(Storage::url('uploads/supports')).'/'.$support->attachment}}"
                                           ...
                                           target="_blank"><span class="btn-inner--icon"><i class="ti ti-download"></i></span></a>
                    ...
                    <div class="card-footer">
                        <div class="align-items-center d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                <div class="action-btn bg-warning rounded">
