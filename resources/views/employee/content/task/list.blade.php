...
@section('action-btn')
    <div class="float-end">
        ...
        @if($view == 'grid')
            <a href="{{ route('employee.tasks.view', 'list') }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="{{__('List View')}}">
                <span class="btn-inner--text"><i class="ti ti-list"></i>{{__('List View')}}</span>
            </a>
        @else
            <a href="{{ route('employee.tasks.view', 'grid') }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="{{__('Grid View')}}">
