...
use App\Http\Controllers\TimemoduleController;
...
Route::resource('timemodule', TimemoduleController::class)->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('company-choice', [HealthJourneyController::class, 'company_choice'])->name('health.company_choice');
Route::resource('health', HealthJourneyController::class)->middleware(['auth', 'XSS', 'revalidate']);
Route::resource('glucose', GlucoseController::class)->middleware(['auth', 'XSS', 'revalidate']);
Route::resource('exercise', ExerciseController::class)->middleware(['auth', 'XSS', 'revalidate']);
Route::resource('weight', WeightController::class)->middleware(['auth', 'XSS', 'revalidate']);
Route::resource('sleep', SleepController::class)->middleware(['auth', 'XSS', 'revalidate']);
